...
describe('Finance V2, Employed', () => {
    const user = new User();
    user.employment = new Employed();
    ...
    const financeDecisionPage: FinanceDicisionPage = new FinanceDicisionPage(1002);
    ...
    it('I can route to Payment Options page', () => {
        ...
        browser.pause(1000);
        paymentMethodPage.feedbackLinkIsDisplayed();
    });
    ...
    it('I can select CarMax financing', () => {
        ...
        browser.pause(1000);
        financePageOne.feedbackLinkIsDisplayed();
    });
    ...
    it('I can complete page one of a finance application', () => {
        ...
        browser.pause(1000);
        financePageTwo.feedbackLinkIsDisplayed();
    });
    it('I can complete page two of a finance application', () => {
        ...
        browser.pause(1000);
        financePageThree.feedbackLinkIsDisplayed();
    });
    it('I can complete page three of a finance application', () => {
        ...
        browser.pause(1000);
        financePageFour.feedbackLinkIsDisplayed();
    });
    it('I can complete page four of a finance application', () => {
        ...
        browser.pause(1000);
        financePageFive.feedbackLinkIsDisplayed();
    });
    it('I can successfully complete a finance application', () => {
        ...
        financeDecisionPage.dicisionPageValidationText("You'll get your results ASAP");
        browser.pause(1000);
        financeDecisionPage.continueToNextStepButton.isDisplayed().should.be.true;
        financeDecisionPage.feedbackLinkIsDisplayed();
    });
});
